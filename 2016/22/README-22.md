...
Our process work. We need to "move our empty" from (26,22) to (30,0), and then
walk the payload out from (31,0) to (0,0). We just need to go via (24,6) to
avoid the blockage!
